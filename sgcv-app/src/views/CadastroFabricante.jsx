...
function CadastroFabricante() {
  ...
  async function salvar() {
    ...
    if (!nomeFantasia || !nomeFantasia.trim()) {
      novosErros.nomeFantasia = "O nome do fabricante é obrigatório.";
    }

    if (!email || !email.trim()) {
      novosErros.email = "O e-mail do fabricante é obrigatório.";
    }

    if (!cnpj || !cnpj.trim()) {
      novosErros.cnpj = "O CNPJ do fabricante é obrigatório.";
    }
    ...
    try {
      ...
      mensagemErro(error?.response?.data || "Erro ao salvar o fabricante.");
    }
  }
